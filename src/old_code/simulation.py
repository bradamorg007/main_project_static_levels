import pygame
from old_code.level_manager import LevelManager
from old_code.agent_manager import AgentManager
from old_code.neuroevolution import NeuroEvolution
from old_code.image_capture import ImageCapture
import os
...
if __name__ == "__main__":
    ...
    LEVEL_MANAGER = LevelManager(FPS=60,
                                 ...
                                 mode='train', load_agent_filepath='sim_data/best_agent',
